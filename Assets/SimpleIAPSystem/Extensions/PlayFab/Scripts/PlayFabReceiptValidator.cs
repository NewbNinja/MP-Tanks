...
namespace SIS
{
    ...
    /// This ensures purchased products are added to the user's inventory correctly.
    /// </summary>
	public class PlayFabReceiptValidator : ReceiptValidator
    {
        ...
        public override void Validate(Product p = null)
        {
            ...
            //if restoring transactions, PlayFab cannot validate the same receipts twice. Treat like without validation
            //for more information see IsRestoreActive method in PlayFabManager
            if (PlayFabManager.GetInstance().IsRestoreActive())
            {
